...
Provides the analyzer for JavaScript source code with all applicable rules.
"""
...
class JavaScriptAnalyzer(BaseAnalyzer):
    ...
    Pre-configured with all rules applicable to JavaScript:
    ...
    def __init__(self, rules: Optional[List[BaseRule]] = None,
        ...
        Args:
            rules: Optional custom list of rules. If None, uses all JS rules.
    ...
    def _get_default_rules(config: Optional[Dict[str, Any]] = None) -> List[BaseRule]:
        """Create the default set of rules for JavaScript analysis.
